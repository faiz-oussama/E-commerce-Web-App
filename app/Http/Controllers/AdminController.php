...
class AdminController extends Controller
{
    public function loginHandler(Request $request){
        ...
        if($fieldType == 'email'){
            $request->validate([
                ...
                'login_id.exists'=> 'This email does not exists',
            ...
            $request->validate([
                ...
                'login_id.required'=> 'Email or Username is required',
                'login_id.exists'=> 'This Username does not exists',
                'password.required'=> 'Password is required'
            ]);
        }
    ...
    public function sendPasswordResetLink(Request $request){
        $request->validate([
            ...
            'email.required'=> 'Email section is required',
        ...
        if(sendEmail($mailConfig)){
            session()->flash('success','We have emailed you your password reset link');
    ...
    public function resetPasswordHandler(Request $request){
        ...
        return redirect()->route('admin.login')->with('success','Done! Your password has been changed succefully!');
    }
