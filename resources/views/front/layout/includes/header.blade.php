            ...
            <div class="col-xl-2 col-7 col-md-8 col-lg-2">
                <div class="wsus_logo_area">
                    <a class="wsus__header_logo" href="index.html">
                        <img src="/images/site/LOGO_65fa12691eafa.png" alt="logo" class="img-fluid w-100">
                    </a>
                </div>
            </div>
        ...
        <ul>
            <li>
                <div class="wsus__cart_img">
                    <a href="#"><img src="/front/images/tab_2.jpg" alt="product" class="img-fluid w-100"></a>
            ...
            <li>
                <div class="wsus__cart_img">
                    <a href="#"><img src="/front/images/pro4.jpg" alt="product" class="img-fluid w-100"></a>
                    <a class="wsis__del_icon" href="#"><i class="fas fa-minus-circle"></i></a>
                </div>
                <div class="wsus__cart_text">
            ...
            <li>
                <div class="wsus__cart_img">
                    <a href="#"><img src="/front/images/pro2.jpg" alt="product" class="img-fluid w-100"></a>
                    <a class="wsis__del_icon" href="#"><i class="fas fa-minus-circle"></i></a>
                </div>
                <div class="wsus__cart_text">
            ...
            <li>
                <div class="wsus__cart_img">
                    <a href="#"><img src="/front/images/pro9.jpg" alt="product" class="img-fluid w-100"></a>
                    <a class="wsis__del_icon" href="#"><i class="fas fa-minus-circle"></i></a>
                </div>
                <div class="wsus__cart_text">
