...
<html>
	<head>
		...
		/>
		<link rel="stylesheet" type="text/css" href="/back/src/styles/style.css" />
		<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.css">
		<link rel="stylesheet" href="/extra/ijaboCropTool.min.css">
		@livewireStyles
        @stack('stylesheets')
		<script>
			(function (w, d, s, l, i) {
	...
	<body>
				...
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						...
						<li>
							...
							<a href="invoice.html" class="dropdown-toggle no-arrow" style="transform: translateX(12px);">
								<span class="micon bi bi-receipt-cutoff"></span
								><span class="mtext">Invoice</span>
							</a>
						</li>
		...
		<script src="/extra/jquery.ijaboViewer.min.js"></script>
		<script src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js"></script>
		<script src="/extra/ijaboCropTool.min.js"></script>
		<script src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js"></script>
